...
public class FRCDriveBrushlessTank extends FRCDriveTank {
    public FRCDriveBrushlessTank(SubsystemConfiguration configuration,
                                 MotorConfig frc,
                                 MotorConfig flc,
                                 MotorConfig brc,
                                 MotorConfig blc) {
        super(
                configuration,
                FRCMotorFactory.newSparkBrushless(
